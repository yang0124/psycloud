...
<body onload="javascript:initUEditor();">
<div>
    <h1>完整demo</h1>
    <form action="" name="" method="post">
    <script id="editor" name="editor" type="text/plain" style="width:512px;height:200px;"></script>
    </form>
    <input type="button" value="获取HTML内容" onclick="getHtml();">
