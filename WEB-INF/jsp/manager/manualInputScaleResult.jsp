...
<div class="modal fade bs-example-modal-sm" tabindex="-1"
			...
			id="addManualInput" style="display: none">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">手工录入数据</h4>
			</div>
			<div class="modal-body">
				<form class="form-horizontal" action=" " method="" novalidate
							id="addManulInputForm">
					<div class="control-group">
						<label class="control-label" for="alert_code">选择批次</label>
						<div class="controls">
					...
					<tr>
						...
						<td>
							<div class="btn-group btn-group-xs" role="group"
								...
								<button id="${item.id }" type="button" class="btn btn-small"
												onclick='windowOpen("${basePath}/selectTestAction/editTestBatch?id=${item.id }")'>删除</button>
							</div>
						</td>
					</tr>
				</c:forEach>
