			...
			<div id="page-content" class="clearfix">
				...
				<div class="row-fluid">
					<table id="table_report"
						...
						<thead>
							<tr>
								<th width="10%" style="height: 44px; text-overflow: ellipsis;">编号</th>
								<th style="height: 44px; text-overflow: ellipsis;">量表名称</th>
								<th width="10%" style="height: 44px; text-overflow: ellipsis;">量表类型</th>
						...
						<tbody>
							<c:forEach var="scale_item" items="${scale_list }">
								<tr>
									...
									<td>${scale_item.title_cn }(${scale_item.title_en })</td>
									<td>${scale_item.scale_type_title }</td>
									<td>
										<div class="btn-group btn-group-xs" role="group"
											aria-label="...">
											<button id="${scale_item.id }" type="button"
												onclick='windowOpen("${basePath}/testAction/showScaleGuide?scale_id=${scale_item.id }&batch_id=0","_blank")'
												class="btn btn-small btn-primary">开始测验</button>
											<%-- <button id="${scale_item.id }" type="button"
