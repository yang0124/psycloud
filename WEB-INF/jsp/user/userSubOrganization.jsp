...
<head>
	...
	<script type="text/javascript">
	function addUserSubOrganization() {
		/* alert($('#addUserOrganizationForm').serialize()); */
		$.ajax({
			cache : true,
			type : "POST",
			url : '${basePath}/userSubOrganizationAction/addSubOrganization',
			data : $('#addUserSubOrganizationForm').serialize(),
			async : false,
	...
	<div id="main-content" class="clearfix" style="padding: 20px">
		<div id="page-content" class="clearfix">
				...
				<div class="modal-dialog modal-sm">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModalLabel">添加院系</h4>
						</div>
						<div class="modal-body">
							<form class="form-horizontal" action=" " method="" novalidate
									id="addUserSubOrganizationForm">
								...
								<div class="control-group">
									<label class="control-label" for="user_org_title">院系名称</label>
									<div class="controls">
								...
								<!-- 组织管理员信息 -->
								<div class="control-group">
									<label class="control-label" for="org_admin_name">管理员姓名</label>
									<div class="controls">
										<input id="org_admin_name" type="text"
												name="org_admin_name"></div>
								</div>
								<div class="control-group">
									<label class="control-label" for="org_admin_account">管理员账号</label>
									<div class="controls">
										<input id="org_admin_account" type="text"
												name="org_admin_account"></div>
								</div>
								<div class="control-group">
									<label class="control-label" for="org_admin_password">管理员密码</label>
									<div class="controls">
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-primary"
									data-dismiss="modal" onclick="addUserSubOrganization()">确定</button>
						</div>
					</div>
				</div>
			</div>
			<div class="row-fluid">
				...
				<tbody>
					<c:forEach var="item" items="${sub_org_list }">
						<tr>
							<!-- <td>${item.id }</td>
						-->
