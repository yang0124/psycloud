...
<head>
	...
	function addOrgTeam() {
		...
		$.ajax({
			cache : true,
			type : "POST",
			url : '${basePath}/userTeamAction/addOrgTeam',
			data : $('#addOrgTeamForm').serialize(),
			async : false,
				...
				<div class="modal-dialog modal-sm">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModalLabel">添加院系专业</h4>
						</div>
						<div class="modal-body">
							<form class="form-horizontal" action=" " method="" novalidate
								...
								<div class="control-group">
									<label class="control-label" for="team_title">专业名称</label>
									<div class="controls">
										<input id="team_title" type="text"
												name="team_title"></div>
								</div>
							</form>
						</div>
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-primary"
									data-dismiss="modal" onclick="addOrgTeam()">确定</button>
						</div>
					</div>
				</div>
			</div>
