	...
	<script type="text/javascript">
		function addTeacher() {
			...
			$.ajax({
				cache : true,
				type : "POST",
				url : '${basePath}/userAction/addTeacher',
...
<div id="main-content" class="clearfix">
	<div id="page-content" class="clearfix">
		<div class="page-header position-relative">
			<h1>
				教师管理
				<button class="btn btn-mini btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal" action=" " method="" novalidate
									id="addTeacherForm">
							<input type="text" name="area_id" value="${user_permissions.area_id}" style="display:none">
							<input type="text" name="org_id" value="${user_permissions.org_id}" style="display:none">
							<input type="text" name="sub_org_id" value="${user_permissions.sub_org_id}" style="display:none">
							<!-- 组织基本信息 -->
							<div class="control-group">
								<label class="control-label" for="teacher_name">姓名</label>
								<div class="controls">
									<input id="teacher_name" type="text"
												name="teacher_name"></div>
							</div>
							<div class="control-group">
								<label class="control-label" for="teacher_account">账号</label>
								<div class="controls">
									<input id="teacher_account" type="text"
												name="teacher_account"></div>
							</div>
							<div class="control-group">
								<label class="control-label" for="teacher_password">初始密码</label>
								<div class="controls">
									<input id="teacher_password" type="text"
												name="teacher_password"></div>
							</div>
							<div class="control-group">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary"
									data-dismiss="modal" onclick="addTeacher()">确定</button>
					</div>
				</div>
			</div>
		</div>
							...
							<td>
								<div class="btn-group btn-group-xs" role="group"
									...
									<button id="${item.id }" type="button" class="btn btn-small btn-success"
													onclick='windowOpen("${basePath}/userAction/editUserPermission?user_id=${item.id }")'>设置权限</button>
