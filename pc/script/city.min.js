...
$(function(){ //调用插件
	...
	var cho_City = "";
	var cho_Area = "";
	cho_Province = $("input[name=cho_Province]").val();
	cho_City = $("input[name=cho_City]").val();
	cho_Area = $("input[name=cho_Area]").val();
	if(cho_Province == null || cho_Province == ''){
		cho_Province="请选择省份";
	}
	if(cho_City == null || cho_City == ''){
		cho_City="请选择城市";
	}
	if(cho_Area == null || cho_Area == ''){
		cho_Area="请选择地区";
	}
